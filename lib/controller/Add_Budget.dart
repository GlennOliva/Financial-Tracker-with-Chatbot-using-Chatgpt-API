...
class _AddBudgetState extends State<AddBudget> {
 ...
 Future<void> createBudget(String userId) async {
  // Create a reference to the 'expense' collection in Firestore
  final docBudget = FirebaseFirestore.instance.collection('budget').doc();

  // Check if a file is picked
  if (pickedFile != null) {
    // Upload the file to Firebase Storage
    final storageRef = FirebaseStorage.instance.ref().child('images/${docBudget.id}');
    ...
    // Show success message using SnackBar
    showSuccessSnackBar('Budget successfully added!');
  }
}
              ...
              child: GestureDetector(
                ...
                child: (pickedFile != null) ? imgExist() : imgNotExist(),
                  ...
                  ElevatedButton(
                    ...
                    child: const Text('ADD BUDGET' , style: TextStyle(color: Colors.black),),
                  ),
                  buildProgress(),
                  const SizedBox(height: 15),
                  (isError)

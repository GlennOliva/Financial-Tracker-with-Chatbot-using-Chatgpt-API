...
class _AddInvestmentState extends State<AddInvestment> {
 ...
 Future<void> createInvestment(String userId) async {
  // Create a reference to the 'expense' collection in Firestore
  final docInvestment = FirebaseFirestore.instance.collection('investment').doc();

  // Check if a file is picked
  if (pickedFile != null) {
    // Upload the file to Firebase Storage
    final storageRef = FirebaseStorage.instance.ref().child('images/${docInvestment.id}');
              ...
              child: GestureDetector(
                ...
                child: (pickedFile != null) ? imgExist() : imgNotExist(),
                  ...
                  ElevatedButton(
                    ...
                    child: const Text('ADD INVESTMENT' , style: TextStyle(color: Colors.black),),
                  ),
                  buildProgress(),
                  const SizedBox(height: 15),
                  (isError)
